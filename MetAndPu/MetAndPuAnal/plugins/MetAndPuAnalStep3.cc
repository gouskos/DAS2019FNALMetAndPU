...
// Class:      MetAndPuAnalStep3
// 
/**\class MetAndPuAnal MetAndPuAnalStep3.cc MetAndPu/MetAndPuAnal/plugins/MetAndPuAnalStep3.cc
...
class MetAndPuAnalStep3 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit MetAndPuAnalStep3(const edm::ParameterSet&);
      ~MetAndPuAnalStep3();
...
//
MetAndPuAnalStep3::MetAndPuAnalStep3(const edm::ParameterSet& iConfig):
...
MetAndPuAnalStep3::~MetAndPuAnalStep3()
{
...
void
MetAndPuAnalStep3::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
MetAndPuAnalStep3::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
MetAndPuAnalStep3::endJob() 
{
  //  file->cd();
  //  tree->Write();
  //  file->Write();
...
void
MetAndPuAnalStep3::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MetAndPuAnalStep3);
